...
function FeaturedProperties({ featuredImage, title, col, room, bed, aircon, kitchen, bathroom, closet, pax}) {
  return (
    <React.Fragment>
        <div className={col}>
            <div className='card featured-card shadow-sm' style={{backgroundImage: `url(${featuredImage})`}}>
