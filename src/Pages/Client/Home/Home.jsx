...
const carouselSlides = [
  ...
  },
  {
    ...
    "interval": 3500,
    "image": "https://mir-s3-cdn-cf.behance.net/project_modules/fs/45965399221413.5eede0c8565af.jpg",
    "alt": "test",
  ...
  },
  {
    ...
    "interval": 3500,
    "image": "https://i.pinimg.com/originals/d6/8a/7f/d68a7f4d07f6c4b841b86505ae0e33f4.jpg",
    "alt": "test",
        ...
        <div className='d-flex flex-column'>
          <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
            ...
            <div id='carouselMedia' className="carousel-inner">
              {
                carouselSlides.map(({interval, image, alt, label, description, active}) => (
                  <Carousel 
                    interval={interval} 
                    image={image} 
                    alt={alt}
          ...
          <div className="container col-xxl-8 px-4 py-5">
            <div id='floorPlanLayout' className="row flex-lg-row-reverse align-items-center g-5 py-5 justify-content-center align-items-center">
              <div className="col-10 col-sm-8 col-lg-6">
                <img src={FloorPlan} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy" />
              </div>
                  ...
                  <div className="container col-xxl-12 col-xl-10 col-lg-12 col-md-12 col-sm-12 px-4 py-5">
                    <div className="row align-items-center g-lg-5 py-5">
                      <div className="col-lg-7 text-center text-lg-start">
                        <h1 className="display-4 fw-bold lh-1 mb-3 text-white">READY FOR NEW EXPERIENCE?</h1>
                        <p className="col-lg-10 fs-4 text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                      </div>
                      <div className="col-md-10 mx-auto col-lg-5">
                        <form id='inquiryForm' className="p-4 p-md-5 border rounded-3 bg-light">
                          ...
                          <button className="w-100 btn btn-lg btn-light mt-4" type="submit">Submit</button>
                          <hr className="my-4" />
                          <small className="text-muted">By clicking submit, you agree to the data privacy act.</small>
                        </form>
                      </div>
                    </div>
                  </div>
