        ...
        <div className='d-flex flex-row flex-wrap gap-5 align-items-center container py-3' id='navigation'>
          ...
          <nav>
            <ul className='d-flex flex-row flex-wrap list-unstyled pt-3'>
              <li>
                <Link to='/home' className='text-decoration-none activelink'>HOME</Link>
              </li>
              <li>
                <Link to='/about' className='text-decoration-none'>ABOUT US</Link>
              </li>
              <li>
                <Link to='/portfolio' className='text-decoration-none'>APARTMENTS</Link>
              </li>
              <li>
                <Link to='/blog' className='text-decoration-none'>TEST</Link>
              </li>
              <li>
                <Link to='/shop' className='text-decoration-none'>TEST</Link>
              </li>
              <li>
                <Link to='/contact' className='text-decoration-none'>CONTACT US</Link>
              </li>
              <li>
                <Link to='/pages' className='text-decoration-none'>TEST</Link>
              </li>
            </ul>
          </nav>
        </div>
