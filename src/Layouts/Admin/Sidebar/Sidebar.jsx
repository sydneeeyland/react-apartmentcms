  ...
  return (
    <React.Fragment>
      <ul className='nav nav-pills flex-column mb-auto gap-1'>
        ...
        <li className="nav-item nav-category">MODULES</li>
        <li className='nav-item'>
          <NavLink to='/admin/rooms' className={({ isActive }) => (isActive ? "nav-link active" : "nav-link")}>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-folder"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
            <span className='nav-title'>Rooms</span>
          </NavLink>
        </li>
        <li className="nav-item nav-category">SITE</li>
        <li className='nav-item'>
